...
const Page = ({ params }) => {
    ...
    const fetchOptions = async () => {
        try {
          ...
          for(let i = 0; i < response.data.length; i ++) {
            ...
            if(curr.Text == params.id) {
                setMyId(curr.TextListId);
            }
          }
        } catch (error) {
    ...
    const fetchCards = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${baseURL}/GetUserDetails?TextListId`, { textlistid: myId });
    ...
    return (
        <Flex direction="column" bg="gray.50" minHeight="100vh" style={{ backgroundColor: "black" }}>
            ...
            <Flex bg="gray.800" p="5" color="white" align="center">
                ...
                <Heading ml={'1%'} className='heartbeat' onClick={()=> {router.push('/')}}>Task Pulse</Heading>
